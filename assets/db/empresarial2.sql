...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2024 a las 03:31:01
...
(91, 10, 71, 43, '2024-11-29 01:50:29', 'HP', '1111111', 30, '45245', '2024-11-28', 'NEGRO', 2000000, 19, 380000, 2380000, 666666);
...
INSERT INTO `salidaproducto` (`id_salida_prod`, `cantidad_sali_prod_KG`, `id_categoria`, `id_producto`, `fecha`, `marca`, `numerofactura`, `id_proveedor`, `nit`, `fechafacturareal`, `referencia`, `PrecioCompra`, `IvaIncluido`, `ValorIva`, `Total`, `usuario_codigo`) VALUES
(52, 5, 71, 43, '2024-11-29 01:51:16', 'HP', '1111111', 30, '45245', '2024-11-29', 'NEGRO', 2000000, 19, 380000, 2380000, 666666);
...
(1, 666666, 'DIEGO', 'PINZON', 'DIEGOPINZON@GMAIL.COM', '123', 1);
...
--
ALTER TABLE `ingresoproducto`
  MODIFY `id_ingr_produc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
...
--
ALTER TABLE `roles`
  MODIFY `rol_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT de la tabla `salidaproducto`
--
ALTER TABLE `salidaproducto`
  MODIFY `id_salida_prod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
